...
class AddMemberForm(forms.ModelForm):
    ...
    mem_img=forms.ImageField(
         widget=forms.FileInput(attrs={"class": "form-control form-control-lg", "placeholder": "Upload Member ID Image"})
    )
    contact = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "form-control form-control-lg", "placeholder": "Enter Member Contact"})
    )
    address = forms.CharField(
        widget=forms.TextInput(attrs={"class": "form-control form-control-lg", "placeholder": "Enter Member address"})
    )

    class Meta:
        model = Member
        fields = ["name", "email","mem_img","contact","address"]
...
class AddBookForm(forms.ModelForm):
    ...
    book_img=forms.ImageField(
         widget=forms.FileInput(attrs={"class": "form-control form-control-lg", "placeholder": "Upload Book Image"})
    )

    description  = forms.CharField(
        widget=forms.TextInput(attrs={"class": "form-control form-control-lg", "placeholder": "Enter Book Description"})
    )
    ...
    class Meta:
        model = Book
        fields = ["title", "author","book_img","description", "category", "quantity", "borrowing_fee"]
